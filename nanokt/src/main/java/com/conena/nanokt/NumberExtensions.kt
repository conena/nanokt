...
/**
 * @return `null` if the Int is zero or `null`. Otherwise the Int is returned.
 */
...
/**
 * @return `null` if the Int is negative or `null`. Otherwise the Int is returned.
 */
inline fun Int?.negativeAsNull() = if (this == null || this < 0) null else this

/**
 * @return 0 if the Int is negative. Otherwise the Int is returned.
 */
inline fun Int?.negativeAsZero() = if (this != null && this < 0) 0 else this

/**
 * @return `null` if the Int is positive or `null`. Otherwise the Int is returned.
 */
inline fun Int?.positiveAsNull() = if (this == null || this > 0) null else this

/**
 * @return 0 if the Int is positive. Otherwise the Int is returned.
 */
inline fun Int?.positiveAsZero() = if (this != null && this > 0) 0 else this
...
/**
 * @return `null` if the Long is zero or `null`. Otherwise the Long is returned.
 */
...
/**
 * @return `null` if the Long is negative or `null`. Otherwise the Long is returned.
 */
inline fun Long?.negativeAsNull() = if (this == null || this < 0L) null else this

/**
 * @return 0 if the Long is negative. Otherwise the Long is returned.
 */
inline fun Long?.negativeAsZero() = if (this != null && this < 0L) 0L else this

/**
 * @return `null` if the Long is positive or `null`. Otherwise the Long is returned.
 */
inline fun Long?.positiveAsNull() = if (this == null || this > 0L) null else this

/**
 * @return 0 if the Long is positive. Otherwise the Long is returned.
 */
inline fun Long?.positiveAsZero() = if (this != null && this > 0L) 0L else this
