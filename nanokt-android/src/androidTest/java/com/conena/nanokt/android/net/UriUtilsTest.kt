...
class UriUtilsTest {
    ...
    fun getPlayStoreUriForApp_web() {
        ...
        val result = getPlayStoreUriForApp(
    ...
    fun getTestTrackWebsiteUriForApp() {
        ...
        val result = getTestTrackWebsiteUriForApp(packageName = "com.conena.navigation.gesture.control")
        assertThat(result.toString()).isEqualTo(expected)
    }
    ...
    fun getPlayStoreUriForDeveloper_web() {
        ...
        val result = getPlayStoreUriForDeveloper(
