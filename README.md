...
dependencies {
    ...
    implementation 'com.conena.nanokt:nanokt-android:1.0.0-beta01'
    // Pure Kotlin Extensions
    implementation 'com.conena.nanokt:nanokt:1.0.0-beta01'
    // Extensions for the Java standard library
    implementation 'com.conena.nanokt:nanokt-jvm:1.0.0-beta01'
}
```
